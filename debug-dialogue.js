  ...
  const sections = [
    ...
    },
    {
      ...
      scenes: [
        ...
        fixed("SOFT_ROOM.CLEANING_RESULT", "掃除を続ける", soft.CLEANING_RESULT),
    ...
    },
    {
      ...
      scene("SOFT_ROOM.NURSE_Z_FOOTWORK_UNLOCK", "Zの足運びヒント・ジャンプ", () => soft.NURSE_Z_FOOTWORK_UNLOCK("5")),
      scene("SOFT_ROOM.NURSE_Z_FOOTWORK_UNLOCK", "Zの足運びヒント・支払い", () => soft.NURSE_Z_FOOTWORK_UNLOCK("6")),
      scene("SOFT_ROOM.NURSE_Z_FOOTWORK_UNLOCK", "Zの足運びヒント・募金", () => soft.NURSE_Z_FOOTWORK_UNLOCK("7")),
      ...
      fixed("SOFT_ROOM.ESCAPE_PROPOSAL", "脱出の提案", soft.ESCAPE_PROPOSAL),
        ...
        fixed("SOFT_ROOM.DOOR_UNLOCK_FAIL", "解除失敗", soft.DOOR_UNLOCK_FAIL),
