...
- `floor`, `floorDark`, `wallTop`, `wallSide`, `door`, `doorSmall`, `window`, `peekWindow`, `bars`, `curtain`, `futon`, `table`, `partition`, `cabinet`, `toilet`, `sink`, `rail`, `railEdge`, `mealHatch*` を変換する。
